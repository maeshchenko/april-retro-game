...
export const CARDS = {
  ...
  // ── STEP 3 — Family 1 (all step3_1 screens) ──
  s3f1_1: {
    bg: '#3cda83',
  ...
  // ── STEP 3 — Family 2 (all step3_2 screens) ──
  s3f2_1: {
    bg: '#3cda83',
  ...
  // ── STEP 3 — Family 3 (all step3_3 screens) ──
  s3f3_1: {
    bg: '#3cda83',
...
export const STEP3_FAMILIES = {
  1: ['s3f1_1', 's3f1_2', 's3f1_3'],
  2: ['s3f2_1', 's3f2_2', 's3f2_3'],
  3: ['s3f3_1', 's3f3_2', 's3f3_3'],
};
